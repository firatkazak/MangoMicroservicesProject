...
using Mango.Services.OrderAPI.Models.Model;
...
public class OrderAPIController : ControllerBase
{
    ...
    public OrderAPIController(AppDbContext db, IMapper mapper, IConfiguration configuration, IMessageBus messageBus)
    {
        _db = db;
